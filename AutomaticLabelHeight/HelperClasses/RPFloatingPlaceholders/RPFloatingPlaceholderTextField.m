...
- (void)setupViewDefaults
{
    ...
    self.floatingLabel.font = [UIFont fontWithName:@"Avenir-Heavy" size:15];
    ...
    // view frame
   // self.originalTextFieldFrame = UIEdgeInsetsInsetRect(self.frame, UIEdgeInsetsMake(5.f, 5.f, 2.f, 0.f));
    self.originalTextFieldFrame = UIEdgeInsetsInsetRect(self.frame, UIEdgeInsetsMake(15.f, 0.f, 0.f, 15.f));
...
//                                                 self.originalTextFieldFrame.size.width - 10.f, self.floatingLabel.frame.size.height);
    ...
    self.offsetFloatingLabelFrame = CGRectMake(self.originalFloatingLabelFrame.origin.x, (self.originalFloatingLabelFrame.origin.y - offset)+1,
...
{
    //return [super textRectForBounds:UIEdgeInsetsInsetRect(bounds, UIEdgeInsetsMake(0.f, 0.f, 0.f, 5.f))];
    return [super textRectForBounds:UIEdgeInsetsInsetRect(bounds, UIEdgeInsetsMake(10.f, 0.f, 0.f, 0.f))];
}

// Adds padding so these text fields align with RPFloatingPlaceholderTextView's
- (CGRect)editingRectForBounds:(CGRect)bounds
{
    //return [super editingRectForBounds:UIEdgeInsetsInsetRect(bounds, UIEdgeInsetsMake(0.f, 0.f, 0.f, 5.f))];
    return [super editingRectForBounds:UIEdgeInsetsInsetRect(bounds, UIEdgeInsetsMake(10.f, 0.f, 0.f, 0.f))];
}
...
- (void)textFieldDidBeginEditing:(NSNotification *)notification
{
    ...
    [self animateFloatingLabelColorChangeWithAnimationBlock:^{
        ...
        self->_floatingLabel.textColor = strongSelf.floatingLabelActiveTextColor;
    }];
}
